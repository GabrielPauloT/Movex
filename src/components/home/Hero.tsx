          ...
          <div className="hero-content text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400">
              <Link href="/volume-calculator">
                <Button size="lg" className="w-full sm:w-72 h-14 px-8 text-lg shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all hover:-translate-y-0.5">{t('buttons.calculate')}</Button>
              </Link>
              <a href={PHONE_TEL_HREF} className="hidden sm:block">
                <Button variant="accent" size="lg" className="w-full sm:w-72 h-14 px-8 text-lg">
